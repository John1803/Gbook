...
namespace Willothewisp\Bundle\GuestbookBundle\Twig\Extensions;

class WillothewispTwigSocialBar extends \Twig_Extension {
    ...
    public function getSocialButtons($parameters = array())
    {
        ...
        return $this->container->get('willothewisp.socialBarHelper')->socialButtons($render_parameters);
    }
    ...
    public function getFacebookLikeButton($parameters = array())
    {
        ...
        return $this->container->get('willothewisp.socialBarHelper')->facebookButton($parameters);
    }
    ...
    public function getTwitterButton($parameters = array())
    {
        ...
        return $this->container->get('willothewisp.socialBarHelper')->twitterButton($parameters);
    }
    ...
    public function getGooglePlusButton($parameters = array())
    {
        ...
        return $this->container->get('willothewisp.socialBarHelper')->googlePlusButton($parameters);
    }
}